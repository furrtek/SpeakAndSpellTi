...
DISP/KB1	Page 15	Increment R-line counter, turn off last one, check if 8 characters done. NoÂ : BL to DSP2, YesÂ : turn off filament, | call to TIMEUP1 |
...
ROM	Page 7	Module switchÂ ? Adds 8 to (8,6)
